...
open class SideMenuController: UIViewController {
    ...
    private func changeMenuVisibility(reveal: Bool,
        ...
        if shouldCallDelegate {
            ...
            self.menuViewController.view.layer.shadowOpacity = reveal ? 0.8 : 0
        }
    ...
    private func setStatusBar(hidden: Bool, animate: Bool = false) {
        ...
        ///------FIX CRASH APP CHANGE STATUS BAR
...
//        }
    ...
    open override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        return self.menuViewController?.supportedInterfaceOrientations ?? .portrait// preferences.basic.supportedOrientations
    }
