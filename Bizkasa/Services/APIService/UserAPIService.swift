...
protocol UserAPIServiceProtocol {
    func login(userName: String,
               password: String,
               success: @escaping SuccessHandler<UserEntity>.object,
               failure: @escaping RequestFailure)
    
    func getReceiptReport(
        period: Int,
        success: @escaping SuccessHandler<ReceipReportEntity>.array,
        failure: @escaping RequestFailure)
    
    func reportRevenue(shiftID: Int,
                       success: @escaping SuccessHandler<RevenueEntity>.object,
                       failure: @escaping RequestFailure)
...
class UserAPIService: UserAPIServiceProtocol {
    ...
    func completedRegiser(
        param: CompleteRegisterParam,
        success: @escaping SuccessHandler<UserEntity>.object,
        failure: @escaping RequestFailure) {
