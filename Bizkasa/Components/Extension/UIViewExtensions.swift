...
//public extension UIView {
//
//  public func addBorder(edges: UIRectEdge, color: UIColor = #colorLiteral(red: 0.5921568627, green: 0.5921568627, blue: 0.5921568627, alpha: 1), thickness: CGFloat = 1.0) -> [UIView] {
//    var borders = [UIView]()
//
//    func border() -> UIView {
